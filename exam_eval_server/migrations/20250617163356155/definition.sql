...
CREATE TABLE "answer" (
    ...
    "submittedAnswer" json NOT NULL,
    "evaluatedScore" json NOT NULL
);
...
--
-- Class Registrations as table registrations
--
...
--
-- Class ResultBatch as table result_batch
--
...
--
-- Foreign relations for "result" table
--
ALTER TABLE ONLY "result"
    ADD CONSTRAINT "result_fk_0"
    FOREIGN KEY("examId")
    REFERENCES "exam"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "result"
    ADD CONSTRAINT "result_fk_1"
    FOREIGN KEY("answers")
...
--
-- Foreign relations for "result_batch" table
--
ALTER TABLE ONLY "result_batch"
    ADD CONSTRAINT "result_batch_fk_0"
...
--
-- Foreign relations for "userview" table
--
ALTER TABLE ONLY "userview"
    ADD CONSTRAINT "userview_fk_0"
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('exam_eval', '20250617163356155', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250617163356155', "timestamp" = now();
